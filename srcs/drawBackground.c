...
/*   Updated: 2023/01/08 22:12:22 by mikuiper      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
{
	game->mapdata.ceilingColor = getRGBA(	game->mapdata.ceilingRGB[0], \
											game->mapdata.ceilingRGB[1], \
											game->mapdata.ceilingRGB[2], \
											255);
	game->mapdata.floorColor = getRGBA(		game->mapdata.floorRGB[0], \
