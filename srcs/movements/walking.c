...
With the defined preprocessor variable WALL_BOUNCE, you can configure how much
...
{
	if (map[(int)(pos->y + WALL_BOUNCE)][(int)(pos->x + dir->x * moveSpeed)] != '1'
		&& map[(int)(pos->y - WALL_BOUNCE)][(int)(pos->x + dir->x * moveSpeed)] != '1'
		&& map[(int)(pos->y)][(int)(pos->x + dir->x * moveSpeed + WALL_BOUNCE)] != '1'
		&& map[(int)(pos->y)][(int)(pos->x + dir->x * moveSpeed - WALL_BOUNCE)] != '1')
		pos->x = pos->x + dir->x * moveSpeed;
	if (map[(int)(pos->y + dir->y * moveSpeed + WALL_BOUNCE)][(int)(pos->x)] != '1'
		&& map[(int)(pos->y + dir->y * moveSpeed - WALL_BOUNCE)][(int)(pos->x)] != '1'
		&& map[(int)(pos->y + dir->y * moveSpeed)][(int)(pos->x + WALL_BOUNCE)] != '1'
		&& map[(int)(pos->y + dir->y * moveSpeed)][(int)(pos->x - WALL_BOUNCE)] != '1')
...
{
	if (map[(int)(pos->y + WALL_BOUNCE)][(int)(pos->x - dirPerp->x * moveSpeed)] != '1'
		&& map[(int)(pos->y - WALL_BOUNCE)][(int)(pos->x - dirPerp->x * moveSpeed)] != '1'
		&& map[(int)(pos->y)][(int)(pos->x - dirPerp->x * moveSpeed + WALL_BOUNCE)] != '1'
		&& map[(int)(pos->y)][(int)(pos->x - dirPerp->x * moveSpeed - WALL_BOUNCE)] != '1')
		pos->x = pos->x - dirPerp->x * moveSpeed;
	if (map[(int)(pos->y - dirPerp->y * moveSpeed + WALL_BOUNCE)][(int)(pos->x)] != '1'
		&& map[(int)(pos->y - dirPerp->y * moveSpeed - WALL_BOUNCE)][(int)(pos->x)] != '1'
		&& map[(int)(pos->y - dirPerp->y * moveSpeed)][(int)(pos->x + WALL_BOUNCE)] != '1'
		&& map[(int)(pos->y - dirPerp->y * moveSpeed)][(int)(pos->x - WALL_BOUNCE)] != '1')
